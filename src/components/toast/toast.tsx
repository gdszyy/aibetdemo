    ...
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
                ...
                fill="#C4C4C4"
            />
            <g className="toast-weak-signal-dot" filter="url(#filter0_d_8906_105957)">
                <path
            ...
            <defs>
                ...
                >
                    ...
                    <feColorMatrix
                        type="matrix"
                        values="0 0 0 0 0.686275 0 0 0 0 0.0196078 0 0 0 0 0.027451 0 0 0 1 0"
                    />
                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_8906_105957" />
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_8906_105957" result="shape" />
                </filter>
            </defs>
        </svg>
    );
