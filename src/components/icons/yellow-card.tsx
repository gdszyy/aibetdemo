...
const SvgYellowCard = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#yellow-card_svg__a)" filter="url(#yellow-card_svg__b)">
      <path
        fill="#FFC700"
    ...
    <defs>
      <clipPath id="yellow-card_svg__a">
        <path fill="#fff" d="M0 0h14v14H0z" />
      </clipPath>
      <filter
        id="yellow-card_svg__b"
        width={15}
        height={14.467}
        x={-1.456}
        y={-0.733}
      ...
      >
        ...
        <feBlend in2="shape" result="effect1_innerShadow_4013_106748" />
      </filter>
    </defs>
  </svg>
);
