...
| 函数名 | 类型 | 签名 | 备注 |
|--------|------|------|------|
| resolveType2ColumnHeaders | function | `resolveType2ColumnHeaders(market: MarketGroup, outcomes: OutcomeModel[])` |  |
| measureTextWidth | function | `measureTextWidth(text: string, font = '13px Inter, sans-serif')` |  |
