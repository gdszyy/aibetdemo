...
## Background And Surface Standards
...
Use shadows only for popovers, tooltips, drawers, bottom sheets, floating bet slip, and mobile fixed bars.
...
Theme reusable controls inside those pages, but preserve intentional artwork unless the task explicitly says campaign pages should follow the new theme.
